...
-- Add database-level connection pooling hints
-- These settings help optimize connection reuse and reduce overhead
...
ALTER DATABASE postgres SET shared_preload_libraries = 'pg_stat_statements'; -- Enable query stats
